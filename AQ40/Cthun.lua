...
local timeReschedule = 45      -- delay from the moment of weakening for timers to restart
...
function BigWigsCThun:CThunWeakened()
	...
	self:ScheduleEvent("bwcthunstartgiant", self.StartGiantCRape, timeReschedule + 10, self )
	self:ScheduleEvent("bwcthunstartgiantc", self.StartGiantRape, timeReschedule + 40, self )
	self:ScheduleEvent("bwcthunstarttentacles", self.StartTentacleRape, timeReschedule + 30, self )
end
